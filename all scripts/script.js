...
for (let i = 0; i < allOrangeJuiceByClass.length; i++) {
  ...
  allOrangeJuiceByClass[i].style.border = "2px solid white";
}
...
for (let i = 0; i < allOrangeJuiceByClass.length; i++) {
  ...
  allOrangeJuiceByClass[i].style.border = "2px solid black";
}
...
for (let i = 0; i < allOrangeJuiceByClass2.length; i++) {
  ...
  allOrangeJuiceByClass2[i].style.border = "2px solid black";
}
